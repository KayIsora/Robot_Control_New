...
//điều kiển bánh xe, có chia sẻ vùng nhớ với mỗi lần chạy update
...
int main(int argc, char **argv)
{
  ...
  sem_consumer = sem_open(SEM_CONSUMER_NAME, O_CREAT, 0666, 1);
  ...
  while (true)
  {
    ...
    if (object_tracked_or_detected) {
        ...
        // Ví dụ:
        // if (shared_data->fall_probability > 0.5) {
